...
<body>
    <nav class="navbar navbar-expand-md sticky-top py-3 navbar-dark" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"></a><button
            ...
            <div class="collapse navbar-collapse" id="navcol-1"><img
                    src="assets/img/brands/Tarjeta%20Horizontal%20Gracias%20por%20tu%20Compra%20Minimalista%20Beige%20(1).png"
                    width="62" height="74">
        ...
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Inicia Sesion</p>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-6 col-xl-4">
                    <div>
                    <form class="p-3 p-xl-4" method="post" action="verifi\verifi_user_bd.php">
                
                            <div class="mb-3"><input class="form-control" type="text" id="usuario" name="usuario"
                                    placeholder="Usuario" required></div>
                            <div class="mb-3"><input class="form-control" type="password" id="pass" name="pass"
                                    placeholder="Contraseña" required></div>
                            <div class="mb-3"></div>
                            <div><button class="btn btn-primary shadow d-block w-100" data-bss-hover-animate="bounce"
                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">+502 55092923</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            <div
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">chenbolh@gmail.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            <div
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">4 calle 8-50 zona 6 barrio San Vicente </p>
                            </div>
                        </div>
                    </div>
                </div>
